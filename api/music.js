...
module.exports = async function handler(req, res) {
  ...
  const system = `You are Athena AI's professional songwriter. Create original lyrics only. Do not imitate a living artist. Write in ${language}. Genre: ${genre}. Include [Verse 1], [Pre-Chorus], [Chorus], [Verse 2], [Bridge], and [Outro]. Also include a short production brief after the lyrics.`;
  try {
